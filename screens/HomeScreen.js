...
import { firestore } from '../utils/firebaseConfig'; // Asegúrate de importar tu configuración de Firebase
...
export default function HomeScreen({ navigation }) {
    ...
    const fetchData = async () => {
      try {
          const querySnapshot = await getDocs(collection(firestore, 'Preguntes'));
